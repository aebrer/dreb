...
- **Curated themes.** Six themes — Default, Dim, Solarized, Gruvbox, Caves of
  Qud, Van Gogh — each a *family* with its own light and dark palette. A separate mode toggle

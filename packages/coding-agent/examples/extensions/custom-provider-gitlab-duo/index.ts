 ...
 * Delegates to @dreb/ai's built-in Anthropic and OpenAI streaming implementations.
 *
 * Usage:
 *   dreb -e ./packages/coding-agent/examples/extensions/custom-provider-gitlab-duo
...
export default function (dreb: ExtensionAPI) {
	dreb.registerProvider("gitlab-duo", {

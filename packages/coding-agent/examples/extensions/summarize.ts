import { complete, getModel } from "@dreb/ai";
import type { ExtensionAPI, ExtensionCommandContext } from "@dreb/coding-agent";
import { DynamicBorder, getMarkdownTheme } from "@dreb/coding-agent";
import { Container, Markdown, matchesKey, Text } from "@dreb/tui";
...
export default function (dreb: ExtensionAPI) {
	dreb.registerCommand("summarize", {

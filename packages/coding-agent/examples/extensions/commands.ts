 ...
 * Commands Extension
 *
 * Demonstrates the dreb.getCommands() API by providing a /commands command
...
import type { ExtensionAPI, SlashCommandInfo } from "@dreb/coding-agent";

export default function commandsExtension(dreb: ExtensionAPI) {
	dreb.registerCommand("commands", {

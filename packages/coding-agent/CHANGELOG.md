...
- Updated the default model for `minimax` and `minimax-cn` providers to `MiniMax-M3` (1M-token context window, 512K max output). ([#281](https://github.com/aebrer/dreb/pull/281))

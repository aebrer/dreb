...
- MiniMax M3 (`MiniMax-M3`) support for the `minimax` and `minimax-cn` providers — 1M-token context window with 512K max output, exposed as a direct-supported entry in the model generator. ([#281](https://github.com/aebrer/dreb/pull/281))

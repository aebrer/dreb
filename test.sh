...
unset XAI_API_KEY GROQ_API_KEY CEREBRAS_API_KEY HF_TOKEN ZAI_API_KEY MISTRAL_API_KEY MINIMAX_API_KEY KIMI_API_KEY
unset AI_GATEWAY_API_KEY OPENROUTER_API_KEY OPENCODE_API_KEY GOOGLE_CLOUD_API_KEY GOOGLE_CLOUD_PROJECT GCLOUD_PROJECT GOOGLE_CLOUD_LOCATION
unset AWS_PROFILE AWS_ACCESS_KEY_ID AWS_SECRET_ACCESS_KEY AWS_SESSION_TOKEN AWS_BEARER_TOKEN_BEDROCK BEDROCK_EXTENSIVE_MODEL_TEST

...
**Curated appearance themes.** A theme gallery in settings offers four dashboard-native themes (Default, Dim, Solarized, Gruvbox), each with its own light and dark palette, plus a system/light/dark mode toggle. Choices are saved per browser and are independent of your TUI theme.
